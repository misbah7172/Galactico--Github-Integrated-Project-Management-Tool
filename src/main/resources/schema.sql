...
-- Add foreign key constraint for tasks -> sprints after sprints table is created
...
-- Project team history table - stores history of team assignments to projects  
...
-- Task status table - stores task status definitions
