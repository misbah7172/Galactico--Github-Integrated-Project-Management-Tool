...
-- Task history table - stores timeline of task changes for Jira-like functionality
CREATE TABLE task_history (
    ...
    action_type VARCHAR(50) NOT NULL CHECK (action_type IN (
        'TASK_CREATED', 'FIELD_UPDATED', 'STATUS_CHANGED', 'ASSIGNED', 'UNASSIGNED',
        'PRIORITY_CHANGED', 'SPRINT_CHANGED', 'MOVED_TO_BACKLOG', 'COMMENT_ADDED',
        'ATTACHMENT_ADDED', 'TIME_LOGGED', 'TASK_BLOCKED', 'TASK_UNBLOCKED',
        'TASK_DELETED', 'TASK_ARCHIVED', 'TASK_RESTORED', 'ESTIMATION_UPDATED',
        'DUE_DATE_CHANGED', 'LABELS_UPDATED', 'DESCRIPTION_UPDATED',
        'ACCEPTANCE_CRITERIA_UPDATED', 'TASK_LINKED', 'TASK_UNLINKED'
    )),
...
-- Backlog items table - stores product and sprint backlog items
CREATE TABLE backlog_items (
    ...
    issue_type VARCHAR(20) NOT NULL DEFAULT 'STORY' CHECK (issue_type IN ('STORY', 'TASK', 'BUG', 'EPIC')),
    priority_level VARCHAR(20) NOT NULL CHECK (priority_level IN ('CRITICAL', 'HIGH', 'MEDIUM', 'LOW')),
    priority_rank INTEGER NOT NULL DEFAULT 0,
    story_points INTEGER,
    business_value INTEGER,
    backlog_status VARCHAR(30) NOT NULL CHECK (backlog_status IN (
...
CREATE INDEX idx_task_history_project_id ON task_history(project_id);
...
CREATE INDEX idx_backlog_items_priority_rank ON backlog_items(priority_rank);
CREATE INDEX idx_backlog_items_status ON backlog_items(backlog_status);
CREATE INDEX idx_backlog_items_assignee_id ON backlog_items(assignee_id);